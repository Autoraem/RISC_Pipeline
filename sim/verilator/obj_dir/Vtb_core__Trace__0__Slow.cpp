...
VL_ATTR_COLD void Vtb_core___024root__trace_register(Vtb_core___024root* vlSelf, VerilatedFst* tracep) {
    ...
    VL_ATTR_COLD void Vtb_core___024root__trace_full_0_sub_0(Vtb_core___024root* vlSelf, VerilatedFst::Buffer* bufp) {
        ...
        bufp->fullBit(oldp+37,((1U & (~ (IData)(vlSelfRef.tb_core__DOT__dut__DOT__stall_pc)))));
                                   ...
                                   : ((2U & (IData)(vlSelfRef.tb_core__DOT__dut__DOT__control_inst__DOT__imm_sel))
                                       ...
                                       : ((1U & (IData)(vlSelfRef.tb_core__DOT__dut__DOT__control_inst__DOT__imm_sel))
                                           ...
                                           : (((- (IData)(
                                              ...
                                              | (vlSelfRef.tb_core__DOT__dut__DOT__if_id_reg_q[0U] 
                                                 >> 0x00000014U)))))),32);
        bufp->fullBit(oldp+53,((1U & (vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[5U] 
                                      >> 5U))));
        bufp->fullIData(oldp+54,(((vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[5U] 
                                   << 0x0000001bU) 
                                  | (vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[4U] 
                                     >> 5U))),32);
        bufp->fullIData(oldp+55,(((vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[4U] 
                                   << 0x0000001bU) 
                                  | (vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[3U] 
                                     >> 5U))),32);
        bufp->fullIData(oldp+56,(((vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[3U] 
                                   << 0x0000001bU) 
                                  | (vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[2U] 
                                     >> 5U))),32);
        bufp->fullIData(oldp+57,(((vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[2U] 
                                   << 0x0000001bU) 
                                  | (vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[1U] 
                                     >> 5U))),32);
        bufp->fullCData(oldp+58,((0x0000001fU & vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[1U])),5);
        bufp->fullCData(oldp+59,((vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[0U] 
                                  >> 0x0000001cU)),4);
        ...
        bufp->fullBit(oldp+67,((1U & (vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[0U] 
                                      >> 0x0000000aU))));
        bufp->fullCData(oldp+68,((7U & (vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[0U] 
                                        >> 7U))),3);
        bufp->fullCData(oldp+69,((0x0000007fU & vlSelfRef.tb_core__DOT__dut__DOT__id_ex_reg_d[0U])),7);
        ...
        bufp->fullCData(oldp+89,(vlSelfRef.tb_core__DOT__dut__DOT__forwardA_br),2);
        bufp->fullCData(oldp+90,(vlSelfRef.tb_core__DOT__dut__DOT__forwardB_br),2);
        bufp->fullBit(oldp+91,(vlSelfRef.tb_core__DOT__dut__DOT__stall_pc));
        bufp->fullBit(oldp+92,(vlSelfRef.tb_core__DOT__dut__DOT__flush_ifid));
        bufp->fullBit(oldp+93,(((IData)(vlSelfRef.tb_core__DOT__dut__DOT__stall_pc) 
