...
class alignas(VL_CACHE_LINE_BYTES) Vtb_core___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ tb_core__DOT__dut__DOT__ifid_reg__DOT__stall;
    CData/*0:0*/ tb_core__DOT__dut__DOT__ifid_reg__DOT__flush;
    ...
    CData/*1:0*/ tb_core__DOT__dut__DOT__forwardingunit_inst__DOT__forwardA_br;
    CData/*1:0*/ tb_core__DOT__dut__DOT__forwardingunit_inst__DOT__forwardB_br;
