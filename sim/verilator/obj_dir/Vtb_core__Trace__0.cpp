    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[2U]))) {
        ...
        bufp->chgIData(oldp+56,(((vlSelfRef.tb_core__DOT__dut__DOT__idex_reg__DOT__d[2U] 
                                 ...
                                 (vlSelfRef.tb_core__DOT__dut__DOT__idex_reg__DOT__d[1U] 
                                  >> 5U))),32);
        bufp->chgCData(oldp+57,((0x0000001fU & vlSelfRef.tb_core__DOT__dut__DOT__idex_reg__DOT__d[1U])),5);
        bufp->chgCData(oldp+58,((vlSelfRef.tb_core__DOT__dut__DOT__idex_reg__DOT__d[0U] 
                                 >> 0x0000001cU)),4);
        bufp->chgCData(oldp+59,((3U & (vlSelfRef.tb_core__DOT__dut__DOT__idex_reg__DOT__d[0U] 
                                       >> 0x0000001aU))),2);
        bufp->chgCData(oldp+60,((3U & (vlSelfRef.tb_core__DOT__dut__DOT__idex_reg__DOT__d[0U] 
                                       >> 0x00000018U))),2);
        ...
        bufp->chgBit(oldp+65,((1U & (vlSelfRef.tb_core__DOT__dut__DOT__idex_reg__DOT__d[0U] 
                                     >> 0x0000000bU))));
        bufp->chgBit(oldp+66,((1U & (vlSelfRef.tb_core__DOT__dut__DOT__idex_reg__DOT__d[0U] 
                                     >> 0x0000000aU))));
