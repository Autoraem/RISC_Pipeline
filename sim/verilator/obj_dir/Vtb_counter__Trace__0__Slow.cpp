...
VL_ATTR_COLD void Vtb_counter___024root__trace_init_sub__TOP__0(Vtb_counter___024root* vlSelf, VerilatedFst* tracep) {
...
VL_ATTR_COLD void Vtb_counter___024root__trace_init_top(Vtb_counter___024root* vlSelf, VerilatedFst* tracep) {
...
VL_ATTR_COLD void Vtb_counter___024root__trace_const_0(void* voidSelf, VerilatedFst::Buffer* bufp);
VL_ATTR_COLD void Vtb_counter___024root__trace_full_0(void* voidSelf, VerilatedFst::Buffer* bufp);
void Vtb_counter___024root__trace_chg_0(void* voidSelf, VerilatedFst::Buffer* bufp);
void Vtb_counter___024root__trace_cleanup(void* voidSelf, VerilatedFst* /*unused*/);

VL_ATTR_COLD void Vtb_counter___024root__trace_register(Vtb_counter___024root* vlSelf, VerilatedFst* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_counter___024root__trace_register\n"); );
    Vtb_counter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vtb_counter___024root__trace_const_0, 0U, vlSelf);
    tracep->addFullCb(&Vtb_counter___024root__trace_full_0, 0U, vlSelf);
    tracep->addChgCb(&Vtb_counter___024root__trace_chg_0, 0U, vlSelf);
    ...
    VL_ATTR_COLD void Vtb_counter___024root__trace_full_0_sub_0(Vtb_counter___024root* vlSelf, VerilatedFst::Buffer* bufp);
    ...
    VL_ATTR_COLD void Vtb_counter___024root__trace_full_0_sub_0(Vtb_counter___024root* vlSelf, VerilatedFst::Buffer* bufp) {
        ...
        bufp->fullBit(oldp+2,(vlSelfRef.tb_counter__DOT__reset));
        bufp->fullCData(oldp+3,(vlSelfRef.tb_counter__DOT__count),4);
    }
