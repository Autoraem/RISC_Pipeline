...
void Vtb_counter___024root__trace_decl_types(VerilatedFst* tracep);

void Vtb_counter___024root__trace_init_top(Vtb_counter___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void Vtb_counter::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vtb_counter::trace()' called on non-VerilatedFstC object;"
